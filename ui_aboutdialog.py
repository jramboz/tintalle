...
class Ui_AboutDialog(object):
    def setupUi(self, AboutDialog):
        ...
        self.icon_label.setPixmap(QPixmap(u"tintalle.png"))
        self.icon_label.setScaledContents(True)

        self.horizontalLayout_2.addWidget(self.icon_label, 0, Qt.AlignTop)
        ...
        self.verticalLayout_2.addWidget(self.desc_label, 0, Qt.AlignTop)
